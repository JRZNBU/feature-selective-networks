"""
    PyTorch Implementation of the paper Feature Selective Networks for Object Detection.
    Done as part of a project where I tried lots of things to improve a novel image classifier which used single-angle images and a generator to attempt to classify over 100 classes of objects.  The project as a whole didn't work as well as I wanted, but this was one artifact worth saving.  I did it as part of testing the limits of the current deep learning toolsets, so I might understand what can and can't be done with them.
"""
    #https://arxiv.org/abs/1711.08879
    #http://openaccess.thecvf.com/content_cvpr_2018/papers/Zhai_Feature_Selective_Networks_CVPR_2018_paper.pdf
